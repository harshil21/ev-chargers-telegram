...
async def handle_location(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if "list_of_chargers" not in context.user_data:
        ...
        buttons_in_markup: int = await get_number_of_markup_buttons(markup)
    ...
    new_chargers = [
        i for i in chargers if i not in context.user_data["list_of_chargers"]
    ]
    ...
    length_of_markup: int = await get_number_of_markup_buttons(markup)
